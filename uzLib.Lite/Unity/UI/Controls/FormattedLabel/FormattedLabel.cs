...
class FormattedLabel : IHyperlinkCallback
{
    ...
    public void draw(GUIStyle guiStyleToCopy, string stringStyleIn)
    {
        ...
        string[] commandParts;
        string searchStyle = (stringStyleIn != null && stringStyleIn.Length > 0) ? stringStyleIn : "Label";
                ...
                else if (commandStart == textStart)
                {
                    ...
                    switch (commandParts[0])
                    {
                        ...
                        case "VA":
                            ...
                            break;
                        default:
                            string cmd = line.Substring(commandStart + 1, commandEnd - commandStart - 1);
    ...
    private void drawText(GUIStyle guiStyle, string text)
    {
        Rect lastRect;
        float fillerHeight;
        GUIContent content = new GUIContent(text, _createHyperlinkId);
